...
scene.background = new THREE.Color(0x290202); // fondo oscuro
...
const Texturalava = textureLoader.load('LAVA_TEXT.png');
Texturalava.wrapS = THREE.RepeatWrapping;
Texturalava.wrapT = THREE.RepeatWrapping;
Texturalava.repeat.set(10, 10);

// Tamaño de nuestro escenario
const groundGeometry = new THREE.PlaneGeometry(200, 200);
const groundMaterial = new THREE.MeshStandardMaterial({ map: Texturalava });
const ground = new THREE.Mesh(groundGeometry, groundMaterial);
ground.rotation.x = -Math.PI / 2;
scene.add(ground);

// Luz ambiental
const ambientLight = new THREE.AmbientLight(0xFF2009, 0.3);
...
// loader.load('../escenario/models/rockfence.glb', (gltf) => {
//     entrance = gltf.scene;
